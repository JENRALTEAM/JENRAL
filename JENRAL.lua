------------------------------------------------
-- This Source Was Developed By (ABD) @IF5IF.--
--   This Is The Source Channel @TNNN7 .   --
--                - Jenral -                 --
--        -- https://t.me/TNNN7 --         --
------------------------------------------------ 
...
if not DevABD:get(Server.."IdJENRAL") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevABD:set(Server.."IdJENRAL",DevId) 
else 
print('\27[1;31m┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉') 
end 
os.execute('lua JENRAL.lua') 
end 
if not DevABD:get(Server.."TokenJENRAL") then 
...
DevABD:set(Server.."TokenJENRAL",TokenBot) 
end  
else 
...
Config = {
DevId = DevABD:get(Server.."IdJENRAL"),
TokenBot = DevABD:get(Server.."TokenJENRAL"),
JENRAL = DevABD:get(Server.."TokenJENRAL"):match("(%d+)"),
SudoIds = {DevABD:get(Server.."IdJENRAL")},
}
Create(Config, "./config.lua") 
https.request("https://apiABD.ml/config.php?Get=JENRAL&DevId="..DevABD:get(Server.."IdJENRAL").."&TokenBot="..DevABD:get(Server.."TokenJENRAL").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("JENRAL.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/JENRAL
token="]]..DevABD:get(Server.."TokenJENRAL")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉"
...
f:close() 
DevABD:del(Server.."IdJENRAL");DevABD:del(Server.."TokenJENRAL")
end 
...
NameBot = (DevABD:get(JENRAL..'ABD:NameBot') or 'جنرال ')
--     Source JENRAL     --
...
local Status = DevABD:sismember(JENRAL..'ABD:SecondSudo:',msg.sender_user_id_) 
...
local Status = DevABD:sismember(JENRAL..'ABD:SudoBot:',msg.sender_user_id_) 
...
local Status = DevABD:sismember(JENRAL..'ABD:ManagerAll:',msg.sender_user_id_) 
...
local Status = DevABD:sismember(JENRAL..'ABD:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevABD:sismember(JENRAL..'ABD:VipAll:',msg.sender_user_id_) 
...
local Status = DevABD:sismember(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = DevABD:sismember(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevABD:sismember(JENRAL..'ABD:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevABD:sismember(JENRAL..'ABD:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevABD:sismember(JENRAL..'ABD:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevABD:sismember(JENRAL..'ABD:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevABD:sismember(JENRAL..'ABD:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if DevABD:sismember(JENRAL..'ABD:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevABD:sismember(JENRAL..'ABD:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevABD:sismember(JENRAL..'ABD:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevABD:sismember(JENRAL..'ABD:MuteAll:', user_id) then
var = true
else
var = false
end
...
vardump(JsonInfo)
DevABD:set(JENRAL.."ABD:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevABD:sadd(JENRAL.."ABD:Groups",IdGps) 
DevABD:set(JENRAL.."ABD:Lock:Bots"..IdGps,"del") DevABD:hset(JENRAL.."ABD:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevABD:set(JENRAL..Lock..IdGps,true)
end
if v.ABDConstructors then
for k,IdABDConstructors in pairs(v.ABDConstructors) do
DevABD:sadd(JENRAL..'ABD:ABDConstructor:'..IdGps,IdABDConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevABD:sadd(JENRAL..'ABD:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevABD:sadd(JENRAL..'ABD:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevABD:sadd(JENRAL..'ABD:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevABD:sadd(JENRAL..'ABD:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevABD:sadd(JENRAL..'ABD:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevABD:set(JENRAL.."ABD:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevABD:set(JENRAL.."ABD:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source JENRAL     --
local ABDRank = function(msg) if SudoId(msg.sender_user_id_) then JENRALTEAM  = "المطور" elseif SecondSudo(msg) then JENRALTEAM = "المطور" elseif SudoBot(msg) then JENRALTEAM = "المطور" elseif ManagerAll(msg) then JENRALTEAM = "المدير" elseif AdminAll(msg) then JENRALTEAM = "الادمن" elseif ABDConstructor(msg) then JENRALTEAM = "المالك" elseif BasicConstructor(msg) then JENRALTEAM = "المنشئ" elseif Constructor(msg) then JENRALTEAM = "المنشئ" elseif Manager(msg) then JENRALTEAM = "المدير" elseif Admin(msg) then JENRALTEAM = "الادمن" else JENRALTEAM = "العضو" end return JENRALTEAM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(218385683) then JENRALTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(JENRAL) then JENRALTEAM = 'البوت' elseif SudoId(user_id) then JENRALTEAM = 'المطور الاساسي' elseif DevABD:sismember(JENRAL..'ABD:SecondSudo:', user_id) then JENRALTEAM = 'المطور الثانوي' elseif DevABD:sismember(JENRAL..'ABD:SudoBot:', user_id) then JENRALTEAM = DevABD:get(JENRAL.."ABD:SudoBot:Rd"..chat_id) or 'المطور' elseif DevABD:sismember(JENRAL..'ABD:ManagerAll:', user_id) then JENRALTEAM = DevABD:get(JENRAL.."ABD:Managers:Rd"..chat_id) or 'المدير العام' elseif DevABD:sismember(JENRAL..'ABD:AdminAll:', user_id) then JENRALTEAM = DevABD:get(JENRAL.."ABD:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevABD:sismember(JENRAL..'ABD:VipAll:', user_id) then JENRALTEAM = DevABD:get(JENRAL.."ABD:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevABD:sismember(JENRAL..'ABD:ABDConstructor:'..chat_id, user_id) then JENRALTEAM = 'المالك' elseif DevABD:sismember(JENRAL..'ABD:BasicConstructor:'..chat_id, user_id) then JENRALTEAM = DevABD:get(JENRAL.."ABD:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevABD:sismember(JENRAL..'ABD:Constructor:'..chat_id, user_id) then JENRALTEAM = DevABD:get(JENRAL.."ABD:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevABD:sismember(JENRAL..'ABD:Managers:'..chat_id, user_id) then JENRALTEAM = DevABD:get(JENRAL.."ABD:Managers:Rd"..chat_id) or 'المدير' elseif DevABD:sismember(JENRAL..'ABD:Admins:'..chat_id, user_id) then JENRALTEAM = DevABD:get(JENRAL.."ABD:Admins:Rd"..chat_id) or 'الادمن' elseif DevABD:sismember(JENRAL..'ABD:VipMem:'..chat_id, user_id) then  JENRALTEAM = DevABD:get(JENRAL.."ABD:VipMem:Rd"..chat_id) or 'المميز' elseif DevABD:sismember(JENRAL..'ABD:Cleaner:'..chat_id, user_id) then  JENRALTEAM = DevABD:get(JENRAL.."ABD:Cleaner:Rd"..chat_id) or 'المنظف' else JENRALTEAM = DevABD:get(JENRAL.."ABD:mem:Rd"..chat_id) or 'العضو' end return JENRALTEAM end
--     Source JENRAL     --
...
var = true  
elseif DevABD:sismember(JENRAL..'ABD:SecondSudo:', user_id) then
var = true  
elseif DevABD:sismember(JENRAL..'ABD:SudoBot:', user_id) then
var = true  
elseif DevABD:sismember(JENRAL..'ABD:ManagerAll:', user_id) then
var = true  
elseif DevABD:sismember(JENRAL..'ABD:AdminAll:', user_id) then
var = true  
elseif DevABD:sismember(JENRAL..'ABD:VipAll:', user_id) then
var = true  
elseif DevABD:sismember(JENRAL..'ABD:ABDConstructor:'..chat_id, user_id) then
var = true
elseif DevABD:sismember(JENRAL..'ABD:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevABD:sismember(JENRAL..'ABD:Constructor:'..chat_id, user_id) then
var = true  
elseif DevABD:sismember(JENRAL..'ABD:Managers:'..chat_id, user_id) then
var = true  
elseif DevABD:sismember(JENRAL..'ABD:Admins:'..chat_id, user_id) then
var = true  
elseif DevABD:sismember(JENRAL..'ABD:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local ABD = (JENRAL..'ABD:Filters:'..msg.chat_id_)
if ABD then
...
local UserName = (dp.username_ or "TNNN7")
...
--     Source JENRAL     --
function ABDmoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevABD:get(JENRAL..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source JENRAL     --
...
local var = true 
if DevABD:get(JENRAL.."ABD:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevABD:get(JENRAL..'ABD:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevABD:get(JENRAL..'ABD:ChText') then
local ChText = DevABD:get(JENRAL..'ABD:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevABD:get(JENRAL.."ABD:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevABD:get(JENRAL..'yes'..data.sender_user_id_) == 'delyes' then
DevABD:del(JENRAL..'yes'..data.sender_user_id_, 'delyes')
DevABD:del(JENRAL..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevABD:get(JENRAL..'no'..data.sender_user_id_) == 'delno' then
DevABD:del(JENRAL..'yes'..data.sender_user_id_, 'delyes')
DevABD:del(JENRAL..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⌁︙تم الغاء امر اطردني") 
end
--     Source JENRAL     --
if DataText == '/yesdel' and DevABD:get(JENRAL..'yesdel'..data.sender_user_id_) == 'delyes' then
DevABD:del(JENRAL..'yesdel'..data.sender_user_id_, 'delyes')
DevABD:del(JENRAL..'nodel'..data.sender_user_id_, 'delno')
if DevABD:sismember(JENRAL..'ABD:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevABD:sismember(JENRAL..'ABD:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevABD:sismember(JENRAL..'ABD:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevABD:sismember(JENRAL..'ABD:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevABD:sismember(JENRAL..'ABD:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevABD:sismember(JENRAL..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevABD:sismember(JENRAL..'ABD:Constructor:'..data.chat_id_, data.sender_user_id_) or DevABD:sismember(JENRAL..'ABD:Managers:'..data.chat_id_, data.sender_user_id_) or DevABD:sismember(JENRAL..'ABD:Admins:'..data.chat_id_, data.sender_user_id_) or DevABD:sismember(JENRAL..'ABD:VipMem:'..data.chat_id_, data.sender_user_id_) or DevABD:sismember(JENRAL..'ABD:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevABD:sismember(JENRAL..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevABD:srem(JENRAL..'ABD:Constructor:'..data.chat_id_,data.sender_user_id_)
DevABD:srem(JENRAL..'ABD:Managers:'..data.chat_id_,data.sender_user_id_)
DevABD:srem(JENRAL..'ABD:Admins:'..data.chat_id_,data.sender_user_id_)
DevABD:srem(JENRAL..'ABD:VipMem:'..data.chat_id_,data.sender_user_id_)
DevABD:srem(JENRAL..'ABD:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevABD:srem(JENRAL..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevABD:get(JENRAL.."ABD:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "⌁︙تم الغاء امر تغير المطور الاساسي") 
DevABD:del(JENRAL.."ABD:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevABD:get(JENRAL.."ABD:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevABD:get(JENRAL..'nodel'..data.sender_user_id_) == 'delno' then
DevABD:del(JENRAL..'yesdel'..data.sender_user_id_, 'delyes')
DevABD:del(JENRAL..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⌁︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevABD:get(JENRAL.."ABD:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevABD:smembers(JENRAL..'ABD:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevABD:incrby(JENRAL..'ABD:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevABD:del(JENRAL..'ABD:ListRolet'..data.chat_id_) 
DevABD:del(JENRAL.."ABD:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "⌁︙*صاحب الحظ* ↫ ["..UserName.."]\n⌁︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevABD:del(JENRAL..'ABD:ListRolet'..data.chat_id_) 
DevABD:del(JENRAL.."ABD:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevABD:del(JENRAL.."ABD:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevABD:sismember(JENRAL..'ABD:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevABD:srem(JENRAL..'ABD:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevABD:del(JENRAL..'ABD:Text:GpTexts'..Abbs..data.chat_id_)
DevABD:srem(JENRAL..'ABD:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevABD:smembers(JENRAL..'ABD:Text:GpTexts'..Abbs..data.chat_id_)
if DevABD:get(JENRAL..'ABD:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "⌁︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Abbs) 
DevABD:del(JENRAL..'ABD:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevABD:del(JENRAL..'ABD:Text:GpTexts'..Abbs..data.chat_id_)
DevABD:del(JENRAL..'ABD:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevABD:srem(JENRAL..'ABD:Manager:GpRedod'..data.chat_id_,Abbs)
else
EditMsg(Chat_Id2, Msg_Id2, "⌁︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = DevABD:get(JENRAL..'ABD:Help')
local Text = [[
...
⌁︙م6 ↫ اوامر الاعضاء
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Source Channel](https://t.me/TNNN7)
]] 
keyboard = {} 
...
local Help = DevABD:get(JENRAL..'ABD:Help1')
local Text = [[
...
local Help = DevABD:get(JENRAL..'ABD:Help2')
local Text = [[
⌁︙اوامر الادمنيه ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙الاعدادت
...
local Help = DevABD:get(JENRAL..'ABD:Help3')
local Text = [[
⌁︙اوامر المدراء ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙فحص البوت
...
local Help = DevABD:get(JENRAL..'ABD:Help4')
local Text = [[
⌁︙اوامر المنشئين ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙تنزيل الكل
...
local Help = DevABD:get(JENRAL..'ABD:Help5')
local Text = [[
⌁︙اوامر المطورين ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙الكروبات
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = DevABD:get(JENRAL..'ABD:Help6')
local Text = [[
⌁︙اوامر الاعضاء ↫ ⤈
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
...
if text and DevABD:get(JENRAL.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevABD:get(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevABD:del(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevABD:del(JENRAL.."Set:Cmd:Group:New"..msg.chat_id_)
DevABD:srem(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevABD:del(JENRAL.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevABD:get(JENRAL..'ABD:NameBot') or "جنرال ")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevABD:get(JENRAL..'ABD:NameBot') or "جنرال ")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevABD:get(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevABD:get(JENRAL.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevABD:set(JENRAL.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙ارسل الامر الجديد", 1, 'html')
DevABD:del(JENRAL.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevABD:set(JENRAL.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevABD:get(JENRAL.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevABD:get(JENRAL.."Set:Cmd:Group:New"..msg.chat_id_)
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الامر", 1, 'html')
DevABD:del(JENRAL.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevABD:smembers(JENRAL.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "⌁︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
Cmds = DevABD:get(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevABD:smembers(JENRAL.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevABD:del(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevABD:del(JENRAL.."List:Cmd:Group:New"..msg.chat_id_)
end
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حذف الاوامر المضافه في المجموعه", 1, 'html')
end
if text == "ترتيب الاوامر" then
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevABD:set(JENRAL.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevABD:sadd(JENRAL.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
send(msg.chat_id_, msg.id_,"⌁︙تم ترتيب الاوامر بالشكل التالي ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n⌁︙ايدي ↫ ا\n⌁︙تنزيل الكل ↫ تك\n⌁︙رفع مميز ↫ م\n⌁︙رفع ادمن ↫ اد \n⌁︙رفع مدير ↫ مد \n⌁︙رفع منشئ ↫ من \n⌁︙رفع منشئ اساسي ↫ اس  \n⌁︙تفعيل الايدي بالصوره ↫ تفع\n⌁︙تعطيل الايدي بالصوره ↫ تعط\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉")  
end
if text == "اضف امر" or text == "اضافة امر" or text == "اضافه امر" and ChCheck(msg) then
DevABD:set(JENRAL.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙ارسل الامر القديم", 1, 'html')
return false
end
if text == "حذف امر" or text == "مسح امر" and ChCheck(msg) then 
DevABD:set(JENRAL.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevABD:smembers(JENRAL.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevABD:get(JENRAL.."Comd:New:rt:ABD:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevABD:smembers(JENRAL.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevABD:del(JENRAL.."Comd:New:rt:ABD:"..v..msg.chat_id_)
DevABD:del(JENRAL.."Coomds"..msg.chat_id_)
end
...
DevABD:set(JENRAL.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevABD:sadd(JENRAL.."Coomds"..msg.chat_id_,ComdNew)  
DevABD:setex(JENRAL.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n⌁︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevABD:del(JENRAL.."Comd:New:rt:ABD:"..ComdNew..msg.chat_id_)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حذف الصلاحيه", 1, 'html')
end
if DevABD:get(JENRAL.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء الامر", 1, 'html')
DevABD:del(JENRAL.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevABD:get(JENRAL.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevABD:set(JENRAL.."Comd:New:rt:ABD:"..textn..msg.chat_id_,text)
...
if DevABD:sismember(JENRAL.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrABD = DevABD:get(JENRAL.."Comd:New:rt:ABD:"..DEV_ABBAS..msg.chat_id_)
if mrABD == "مميز" and VipMem(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TNNN7')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevABD:set(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
DevABD:sadd(JENRAL..'ABD:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrABD == "ادمن" and Admin(msg) then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TNNN7')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevABD:set(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)
DevABD:sadd(JENRAL..'ABD:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrABD == "مدير" and Manager(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TNNN7')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevABD:set(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)  
DevABD:sadd(JENRAL..'ABD:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevABD:srem(JENRAL..'ABD:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevABD:del(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrABD == "ادمن" and Admin(msg) then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TNNN7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevABD:srem(JENRAL..'ABD:Admins:'..msg.chat_id_, result.sender_user_id_)
DevABD:del(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrABD == "مدير" and Manager(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TNNN7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
DevABD:srem(JENRAL..'ABD:Managers:'..msg.chat_id_, result.sender_user_id_)
DevABD:del(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrABD == "عضو" then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TNNN7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
end
...
if DevABD:sismember(JENRAL.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrABD = DevABD:get(JENRAL.."Comd:New:rt:ABD:"..text1[2]..msg.chat_id_)
if mrABD == "مميز" and VipMem(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TNNN7')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevABD:sadd(JENRAL..'ABD:VipMem:'..msg.chat_id_, result.id_)
DevABD:set(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrABD == "ادمن" and Admin(msg) then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TNNN7')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevABD:sadd(JENRAL..'ABD:Admins:'..msg.chat_id_, result.id_)
DevABD:set(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrABD == "مدير" and Manager(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TNNN7')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevABD:sadd(JENRAL..'ABD:Managers:'..msg.chat_id_, result.id_)
DevABD:set(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrABD == "عضو" then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TNNN7')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevABD:srem(JENRAL..'ABD:VipMem:'..msg.chat_id_, result.id_)
DevABD:del(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrABD == "ادمن" and Admin(msg) then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TNNN7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevABD:srem(JENRAL..'ABD:Admins:'..msg.chat_id_, result.id_)
DevABD:del(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrABD == "مدير" and Manager(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TNNN7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevABD:srem(JENRAL..'ABD:Managers:'..msg.chat_id_, result.id_)
DevABD:del(JENRAL.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrABD == "عضو" then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TNNN7')..')'..' ❩\n⌁︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevABD:incr(JENRAL..'ABD:UsersMsgs'..JENRAL..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevABD:incr(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevABD:incr(JENRAL..'ABD:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevABD:sismember(JENRAL.."ABD:Users",msg.chat_id_) then
DevABD:sadd(JENRAL.."ABD:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⌁︙اهلا بك مجددا عزيزي المطور \n⌁︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس جنرال  فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if not DevABD:get(JENRAL..'ABD:Start:Time'..msg.sender_user_id_) then
...
local start = DevABD:get(JENRAL.."ABD:Start:Bot")
if start then 
Start_Source = start
else
...
DevABD:setex(JENRAL..'ABD:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source JENRAL     --
if not SecondSudo(msg) and not DevABD:sismember(JENRAL..'ABD:Ban:Pv',msg.sender_user_id_) and not DevABD:get(JENRAL..'ABD:Texting:Pv') then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,chat) 
Dev_ABD(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "TNNN7")..')', 1, 'md') 
...
DevABD:sadd(JENRAL..'ABD:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '⌁︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⌁︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevABD:srem(JENRAL..'ABD:Ban:Pv',data.id_)  
return false  
end 
...
--     Source JENRAL     --
if text and DevABD:get(JENRAL..'ABD:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevABD:del(JENRAL..'ABD:Start:Bots'..msg.sender_user_id_) 
return false
end
DevABD:set(JENRAL.."ABD:Start:Bot",text)  
...
DevABD:set(JENRAL..'ABD:Start:Bots'..msg.sender_user_id_,true) 
...
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل التواصل بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Texting:Pv') 
end
if text == 'تعطيل التواصل' or text == '↫ تعطيل التواصل ⌁' then  
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل التواصل بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Texting:Pv',true) 
end
end
--     Source JENRAL     --
...
DevABD:incr(JENRAL..'ABD:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevABD:set(JENRAL.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevABD:get(JENRAL.."ABD:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevABD:sadd(JENRAL..'ABD:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
DevABD:srem(JENRAL.."ABD:Groups", msg.chat_id_) 
...
if DevABD:get(JENRAL..'ABD:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevABD:incr(JENRAL..'ABD:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevABD:incr(JENRAL..'ABD:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source JENRAL     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevABD:get(JENRAL..'ABD:Lock:FreeBot'..JENRAL) then
if ChatType == 'pv' then
...
DevABD:sadd(JENRAL..'ABD:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevABD:srem(JENRAL..'ABD:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevABD:sadd(JENRAL..'ABD:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevABD:sadd(JENRAL.."ABD:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevABD:sadd(JENRAL.."ABD:ABDConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevABD:srem(JENRAL.."ABD:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevABD:srem(JENRAL.."ABD:ABDConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevABD:sismember(JENRAL..'ABD:Groups',msg.chat_id_) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevABD:get(JENRAL..'ABD:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙عدد اعضاء المجموعه اقل من ↫ *'..(DevABD:get(JENRAL..'ABD:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","⌁︙تم تفعيل المجموعه "..dp.title_)  
DevABD:sadd(JENRAL.."ABD:Groups",msg.chat_id_)
DevABD:sadd(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevABD:set(JENRAL.."ABD:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevABD:set(JENRAL..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source JENRAL     --
local ReFalse = tostring(msg.chat_id_)
if not DevABD:sismember(JENRAL.."ABD:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevABD:get(JENRAL..'ABD:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevABD:sadd(JENRAL..'ABD:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevABD:get(JENRAL.."ABD:Lock:Join"..msg.chat_id_) then
...
if not Manager(msg) then 
local filter = DevABD:smembers(JENRAL.."ABD:FilterPhoto"..msg.chat_id_)
...
if not Manager(msg) then 
local filter = DevABD:smembers(JENRAL.."ABD:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Manager(msg) then 
local filter = DevABD:smembers(JENRAL.."ABD:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevABD:get(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevABD:get(JENRAL..'ABD:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevABD:del(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevABD:srem(JENRAL..'ABD:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevABD:get(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevABD:del(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevABD:srem(JENRAL..'ABD:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevABD:get(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevABD:del(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevABD:srem(JENRAL..'ABD:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevABD:get(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
DevABD:del(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_)
DevABD:del(JENRAL.."ABD:Gif:AllRed"..msg.content_.text_)
DevABD:del(JENRAL.."ABD:Voice:AllRed"..msg.content_.text_)
DevABD:del(JENRAL.."ABD:Audio:AllRed"..msg.content_.text_)
DevABD:del(JENRAL.."ABD:Photo:AllRed"..msg.content_.text_)
DevABD:del(JENRAL.."ABD:Stecker:AllRed"..msg.content_.text_)
DevABD:del(JENRAL.."ABD:Video:AllRed"..msg.content_.text_)
DevABD:del(JENRAL.."ABD:File:AllRed"..msg.content_.text_)
DevABD:del(JENRAL.."ABD:Text:AllRed"..msg.content_.text_)
DevABD:del(JENRAL.."ABD:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source JENRAL     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevABD:get(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevABD:get(JENRAL..'ABD:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevABD:smembers(JENRAL..'ABD:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙⌁︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevABD:del(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevABD:srem(JENRAL..'ABD:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevABD:sadd(JENRAL..'ABD:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevABD:get(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevABD:sismember(JENRAL..'ABD:Manager:GpRedod'..msg.chat_id_,text) then
local JENRALTEAM =  DevABD:smembers(JENRAL..'ABD:Text:GpTexts'..text..msg.chat_id_)
Dev_ABD(msg.chat_id_, msg.id_, 1, '['..JENRALTEAM[math.random(#JENRALTEAM)]..']' , 1, 'md')  
end
end
--     Source JENRAL     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevABD:get(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevABD:get(JENRAL..'DelManagerRep'..msg.chat_id_)
DevABD:srem(JENRAL..'ABD:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ الرد', 1, 'md')
DevABD:del(JENRAL..'ABD:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevABD:del(JENRAL..'DelManagerRep'..msg.chat_id_)
return false
end
DevABD:del(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevABD:get(JENRAL..'ABD:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevABD:set(JENRAL..'ABD:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevABD:set(JENRAL..'ABD:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevABD:set(JENRAL..'ABD:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevABD:set(JENRAL..'ABD:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevABD:set(JENRAL..'ABD:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevABD:set(JENRAL..'ABD:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevABD:set(JENRAL..'ABD:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevABD:set(JENRAL..'ABD:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevABD:get(JENRAL..'ABD:Lock:GpRed'..msg.chat_id_) then 
if DevABD:get(JENRAL..'ABD:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevABD:get(JENRAL..'ABD:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevABD:get(JENRAL..'ABD:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevABD:get(JENRAL..'ABD:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevABD:get(JENRAL..'ABD:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevABD:get(JENRAL..'ABD:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevABD:get(JENRAL..'ABD:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevABD:get(JENRAL..'ABD:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevABD:get(JENRAL..'ABD:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevABD:get(JENRAL..'ABD:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevABD:get(JENRAL..'ABD:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevABD:get(JENRAL..'ABD:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevABD:get(JENRAL..'ABD:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevABD:get(JENRAL..'ABD:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevABD:get(JENRAL..'ABD:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function JENRALTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevABD:get(JENRAL..'ABD:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevABD:get(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevABD:get(JENRAL..'ABD:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevABD:get(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevABD:get(JENRAL..'DelSudoRep')
DevABD:del(JENRAL.."ABD:Sudo:AllRed",DelSudoRep)
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ الرد', 1, 'md')
DevABD:del(JENRAL.."ABD:Add:AllText"..msg.sender_user_id_)
DevABD:del(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_)
DevABD:del(JENRAL.."DelSudoRep")
return false
end
DevABD:del(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevABD:get(JENRAL.."ABD:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevABD:set(JENRAL.."ABD:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevABD:set(JENRAL.."ABD:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevABD:set(JENRAL.."ABD:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevABD:set(JENRAL.."ABD:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevABD:set(JENRAL.."ABD:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevABD:set(JENRAL.."ABD:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevABD:set(JENRAL.."ABD:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevABD:set(JENRAL.."ABD:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم حفظ الرد الجديد', 1, 'md') 
DevABD:del(JENRAL.."ABD:Add:AllText"..msg.sender_user_id_)
DevABD:del(JENRAL..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevABD:get(JENRAL..'ABD:Lock:AllRed'..msg.chat_id_) then
if DevABD:get(JENRAL.."ABD:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevABD:get(JENRAL.."ABD:Video:AllRed"..msg.content_.text_))
end
if DevABD:get(JENRAL.."ABD:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevABD:get(JENRAL.."ABD:File:AllRed"..msg.content_.text_))
end
if DevABD:get(JENRAL.."ABD:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevABD:get(JENRAL.."ABD:Voice:AllRed"..msg.content_.text_))
end
if DevABD:get(JENRAL.."ABD:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevABD:get(JENRAL.."ABD:Audio:AllRed"..msg.content_.text_))
end
if DevABD:get(JENRAL.."ABD:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevABD:get(JENRAL.."ABD:Photo:AllRed"..msg.content_.text_))
end
if  DevABD:get(JENRAL.."ABD:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevABD:get(JENRAL.."ABD:Gif:AllRed"..msg.content_.text_))
end
if DevABD:get(JENRAL.."ABD:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevABD:get(JENRAL.."ABD:Stecker:AllRed"..msg.content_.text_))
end
if DevABD:get(JENRAL.."ABD:Text:AllRed"..msg.content_.text_) then
function JENRALTEAM(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevABD:get(JENRAL..'ABD:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevABD:get(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevABD:get(JENRAL.."ABD:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevABD:sismember(JENRAL..'ABD:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevABD:sadd(JENRAL..'ABD:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source JENRAL     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= JENRAL then
floods = DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevABD:get(JENRAL.."ABD:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevABD:setex(JENRAL.."ABD:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source JENRAL     --
...
DevABD:set(JENRAL..'ABD:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevABD:get(JENRAL..'ABD:PinnedMsg'..msg.chat_id_)
if pin_id and DevABD:get(JENRAL..'ABD:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevABD:get(JENRAL..'ABD:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevABD:del(JENRAL..'ABD:viewget'..msg.sender_user_id_)
else
...
if DevABD:get(JENRAL..'ABD:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevABD:get(JENRAL..'ABD:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevABD:get(JENRAL..'ABD:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevABD:get(JENRAL..'ABD:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevABD:get(JENRAL..'ABD:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevABD:get(JENRAL..'ABD:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevABD:get(JENRAL..'ABD:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevABD:get(JENRAL..'ABD:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevABD:get(JENRAL..'ABD:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevABD:get(JENRAL..'ABD:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevABD:get(JENRAL..'ABD:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source JENRAL     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevABD:get(JENRAL..'ABD:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevABD:get(JENRAL..'ABD:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevABD:get(JENRAL..'ABD:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
local Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
local Welcomes = Welcomes:gsub('firstname',('['..result.first_name_..']' or ''))
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@TNNN7]'))
Dev_ABD(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end 
if DevABD:get(JENRAL.."ABD:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source JENRAL     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevABD:get(JENRAL..'ABD:Lock:BotWelcome') then 
...
if DevABD:sismember(JENRAL..'ABD:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n⌁︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n⌁︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n⌁︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevABD:get(JENRAL.."ABD:Text:BotWelcome") then ABDText = DevABD:get(JENRAL.."ABD:Text:BotWelcome") else ABDText = "⌁︙مرحبا انا بوت اسمي "..NameBot.."\n⌁︙حالة المجموعه ↫ "..BotText.."\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉" end 
if DevABD:get(JENRAL.."ABD:Photo:BotWelcome") then ABDPhoto = DevABD:get(JENRAL.."ABD:Photo:BotWelcome") elseif abbas.photos_[0] then ABDPhoto = abbas.photos_[0].sizes_[1].photo_.persistent_id_ else ABDPhoto = nil end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@TNNN7]'))
Dev_ABD(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source JENRAL     --
--        Contact         --
...
if DevABD:get(JENRAL..'ABD:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source JENRAL     --
...
if DevABD:get(JENRAL..'ABD:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevABD:get(JENRAL..'ABD:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevABD:get(JENRAL..'ABD:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevABD:get(JENRAL..'ABD:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevABD:get(JENRAL..'ABD:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevABD:get(JENRAL..'ABD:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevABD:get(JENRAL..'ABD:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevABD:get(JENRAL..'ABD:Spam:Text'..msg.chat_id_))
end
if DevABD:get(JENRAL..'ABD:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source JENRAL     --
if DevABD:get(JENRAL.."ABD:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"⌁︙تم الغاء حفظ الرابط")       
DevABD:del(JENRAL.."ABD:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevABD:set(JENRAL.."ABD:Groups:Links"..msg.chat_id_,Link)
...
if DevABD:get('JENRALTEAM:'..JENRAL.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevABD:del('JENRALTEAM:'..JENRAL..'id:user'..msg.chat_id_)  
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
DevABD:del('JENRALTEAM:'..JENRAL.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevABD:del('JENRALTEAM:'..JENRAL.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevABD:get('JENRALTEAM:'..JENRAL..'id:user'..msg.chat_id_)  
DevABD:incrby(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_ABD(msg.chat_id_, msg.id_,  1, "⌁︙تم اضافة "..numadded..' رساله', 1, 'md')
DevABD:del('JENRALTEAM:'..JENRAL..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevABD:get('JENRALTEAM:'..JENRAL.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevABD:del('JENRALTEAM:'..JENRAL..'ids:user'..msg.chat_id_)  
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
DevABD:del('JENRALTEAM:'..JENRAL.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevABD:del('JENRALTEAM:'..JENRAL.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevABD:get('JENRALTEAM:'..JENRAL..'ids:user'..msg.chat_id_)  
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevABD:get(JENRAL.."ABD:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevABD:get(JENRAL.."ABD:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⌁︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevABD:get(JENRAL.."ABD:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevABD:get(JENRAL.."ABD:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevABD:get(JENRAL.."ABD:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevABD:smembers(JENRAL..'ABD:Groups') 
local BotName = (DevABD:get(JENRAL.."ABD:NameBot") or 'جنرال ')
local GetJson = '{"BotId": '..JENRAL..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevABD:get(JENRAL.."ABD:Groups:Links"..v)
Welcomes = DevABD:get(JENRAL..'ABD:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
ABDConstructors = DevABD:smembers(JENRAL..'ABD:ABDConstructor:'..v)
Constructors = DevABD:smembers(JENRAL..'ABD:BasicConstructor:'..v)
BasicConstructors = DevABD:smembers(JENRAL..'ABD:Constructor:'..v)
Managers = DevABD:smembers(JENRAL..'ABD:Managers:'..v)
Admis = DevABD:smembers(JENRAL..'ABD:Admins:'..v)
Vips = DevABD:smembers(JENRAL..'ABD:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
--     Source JENRAL     --
if DevABD:get(JENRAL.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_ABD( msg.chat_id_, msg.id_, 1,"⌁︙يوجد فقط ( 6 ) اختيارات\n⌁︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevABD:get(JENRAL.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevABD:del(JENRAL.."SET:GAME"..msg.chat_id_)   
Dev_ABD( msg.chat_id_, msg.id_, 1,'⌁︙*المحيبس باليد رقم* ↫ '..NUM..'\n⌁︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevABD:get(JENRAL..'DevABD4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "⌁︙تم الغاء الامر")
DevABD:del(JENRAL..'DevABD4'..msg.sender_user_id_)
return false  end 
DevABD:del(JENRAL..'DevABD4'..msg.sender_user_id_)
...
DevABD:set(JENRAL..'ABD:ChId',data.id_)
else
...
--     Source JENRAL     --
if DevABD:get(JENRAL.."ABD:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevABD:del(JENRAL.."ABD:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
return false 
end 
DevABD:del(JENRAL.."ABD:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevABD:set(JENRAL.."DevText", DevText)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ كليشة المطور", 1, "md")
end
if DevABD:get(JENRAL..'ABD:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevABD:del(JENRAL..'ABD:NameBot'..msg.sender_user_id_)
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم حفظ اسم البوت ', 1, 'html')
DevABD:del(JENRAL..'ABD:NameBot'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:NameBot', text)
return false 
end
--     Source JENRAL     --
if text == "الرابط" then
if not DevABD:get(JENRAL.."ABD:Lock:GpLinks"..msg.chat_id_) then 
if DevABD:get(JENRAL.."ABD:Groups:Links"..msg.chat_id_) then
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙𝒈𝒓𝒐𝒖𝒑 𝒍𝒊𝒏𝒌 ↬ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"..DevABD:get(JENRAL.."ABD:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM[math.random(#JENRALTEAM)] , 1, 'html') 
return false
end
...
if text and text == (DevABD:get(JENRAL..'ABD:NameBot') or 'جنرال ') then 
NameBot = (DevABD:get(JENRAL..'ABD:NameBot') or 'جنرال ')
...
if tonumber((DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙لم تربح اي نقطه\n⌁︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙عدد النقاط التي ربحتها ↫ '..(DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevABD:del(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevABD:del(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع نقاطك', 1, 'md') end
--     Source JENRAL     --
if text == 'سمايلات' and SourceCh(msg) or text == 'السمايلات' and SourceCh(msg) then
if not DevABD:get(JENRAL..'ABD:Lock:Games'..msg.chat_id_) then
DevABD2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevABD2[math.random(#DevABD2)]
DevABD:set(JENRAL..'ABD:GameNum'..msg.chat_id_,name)
DevABD:del(JENRAL..'ABD:Games:Ids'..msg.chat_id_)
...
Dev_ABD(msg.chat_id_, msg.id_, 1,JENRALTEAM, 1, 'md')
return false
end end
if text == DevABD:get(JENRAL..'ABD:GameNum'..msg.chat_id_) and not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then
if not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then 
JENRALTEAM = '⌁︙مبروك لقد ربحت في اللعبه \n⌁︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_ABD(msg.chat_id_, msg.id_, 1,JENRALTEAM, 1, 'md')
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevABD:set(JENRAL..'ABD:Games:Ids'..msg.chat_id_,true)
end
...
if not DevABD:get(JENRAL..'ABD:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevABD:set(JENRAL.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevABD:setex(JENRAL.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
name = DevABD2[math.random(#DevABD2)]
DevABD:set(JENRAL..'ABD:GameNum2'..msg.chat_id_,name)
DevABD:del(JENRAL..'ABD:Games:Ids'..msg.chat_id_)
...
if text == DevABD:get(JENRAL..'ABD:GameNum2'..msg.chat_id_) and not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then
if not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then 
...
name = DevABD2[math.random(#DevABD2)]
DevABD:set(JENRAL..'ABD:GameNum3'..msg.chat_id_,name)
DevABD:del(JENRAL..'ABD:Games:Ids'..msg.chat_id_)
...
if text == DevABD:get(JENRAL..'ABD:GameNum3'..msg.chat_id_) and not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then
if not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then 
...
DevABD2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevABD2[math.random(#DevABD2)]
DevABD:set(JENRAL..'ABD:GameNum4'..msg.chat_id_,name)
DevABD:del(JENRAL..'ABD:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
if text == DevABD:get(JENRAL..'ABD:GameNum4'..msg.chat_id_) and not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then
if not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then 
...
name = DevABD2[math.random(#DevABD2)]
DevABD:set(JENRAL..'ABD:GameNum5'..msg.chat_id_,name)
DevABD:del(JENRAL..'ABD:Games:Ids'..msg.chat_id_)
...
if text == DevABD:get(JENRAL..'ABD:GameNum5'..msg.chat_id_) then
if not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then 
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevABD:del(JENRAL..'ABD:GameNum5'..msg.chat_id_)
...
name = DevABD2[math.random(#DevABD2)]
DevABD:set(JENRAL..'ABD:GameNum6'..msg.chat_id_,name)
DevABD:del(JENRAL..'ABD:Games:Ids'..msg.chat_id_)
...
if text == DevABD:get(JENRAL..'ABD:GameNum6'..msg.chat_id_) then
if not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then 
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevABD:del(JENRAL..'ABD:GameNum6'..msg.chat_id_)
...
name = DevABD2[math.random(#DevABD2)]
DevABD:set(JENRAL..'ABD:GameNum7'..msg.chat_id_,name)
DevABD:del(JENRAL..'ABD:Games:Ids'..msg.chat_id_)
...
if text == DevABD:get(JENRAL..'ABD:GameNum7'..msg.chat_id_) then
if not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then 
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevABD:del(JENRAL..'ABD:GameNum7'..msg.chat_id_)
...
name = DevABD2[math.random(#DevABD2)]
DevABD:set(JENRAL..'ABD:GameNum8'..msg.chat_id_,name)
DevABD:del(JENRAL..'ABD:Games:Ids'..msg.chat_id_)
...
if text == DevABD:get(JENRAL..'ABD:GameNum8'..msg.chat_id_) then
if not DevABD:get(JENRAL..'ABD:Games:Ids'..msg.chat_id_) then 
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevABD:del(JENRAL..'ABD:GameNum8'..msg.chat_id_)
...
--     Source JENRAL     --
if DevABD:get(JENRAL.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_ABD(msg.chat_id_, msg.id_, 1,"⌁︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevABD:get(JENRAL.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevABD:del(JENRAL..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevABD:del(JENRAL.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙*التخمين الصحيح هو* ↫ '..NUM..'\n⌁︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevABD:incrby(JENRAL..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevABD:get(JENRAL..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevABD:del(JENRAL..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevABD:del(JENRAL.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n⌁︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevABD:get(JENRAL..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevABD:get(JENRAL..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevABD:set(JENRAL.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n⌁︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n⌁︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevABD:setex(JENRAL.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source JENRAL     --
if text == 'روليت' then
if not DevABD:get(JENRAL..'ABD:Lock:Games'..msg.chat_id_) then
DevABD:del(JENRAL.."ABD:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevABD:del(JENRAL..'ABD:ListRolet'..msg.chat_id_)  
DevABD:setex(JENRAL.."ABD:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevABD:get(JENRAL.."ABD:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "⌁︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevABD:set(JENRAL.."ABD:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '⌁︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n⌁︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevABD:del(JENRAL.."ABD:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevABD:get(JENRAL.."ABD:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevABD:sismember(JENRAL..'ABD:ListRolet'..msg.chat_id_,text) then
...
DevABD:sadd(JENRAL..'ABD:ListRolet'..msg.chat_id_,text)
local CountAdd = DevABD:get(JENRAL.."ABD:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevABD:scard(JENRAL..'ABD:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevABD:del(JENRAL.."ABD:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevABD:setex(JENRAL.."ABD:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevABD0 = (DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevABD:incrby(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevABD0)
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙تم بيع '..(DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n⌁︙كل نقطه تساوي 50 رساله', 'md')
DevABD:del(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source JENRAL     --
...
DevABD:sadd(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevABD:sadd(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevABD:get(JENRAL.."ABD:Left:Bot"..JENRAL) and not SecondSudo(msg) then
...
local msguser = tonumber(DevABD:get(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevABD:get(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevABD:get(JENRAL..'ABD:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevABD:setex(JENRAL..'DevABD4'..msg.sender_user_id_,360,true)
...
function JENRALTEAM(extra,result,success)
if DevABD:get(JENRAL.."ABD:Send:Bot"..JENRAL) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"⌁︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevABD:smembers(JENRAL.."ABD:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevABD:smembers(JENRAL.."ABD:Users")
...
DevABD:set(JENRAL..'ABD:viewget'..msg.sender_user_id_,true)
...
⌁︙[Exp Source](https://t.me/T7777J)

⌁︙[Developer](https://t.me/IF5IF)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌁︙[Tws JENRAL](https://t.me/IF5IFBOT)
]]
...
if DevABD:get(JENRAL.."ABD:Kick:Me"..msg.chat_id_) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevABD:set(JENRAL..'yes'..msg.sender_user_id_, 'delyes')
DevABD:set(JENRAL..'no'..msg.sender_user_id_, 'delno')
...
DevABD:set(JENRAL.."ABD:Kick:Me"..msg.chat_id_, true)
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل امر اطردني'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevABD:del(JENRAL.."ABD:Kick:Me"..msg.chat_id_)
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل امر اطردني'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
end
--     Source JENRAL     --
if text == "نزلني" and ChCheck(msg) then
if DevABD:get(JENRAL.."ABD:Del:Me"..msg.chat_id_) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevABD:set(JENRAL..'yesdel'..msg.sender_user_id_, 'delyes')
DevABD:set(JENRAL..'nodel'..msg.sender_user_id_, 'delno')
...
DevABD:set(JENRAL.."ABD:Del:Me"..msg.chat_id_, true)
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل امر نزلني'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevABD:del(JENRAL.."ABD:Del:Me"..msg.chat_id_)
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل امر نزلني'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
end
--     Source JENRAL     --
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:TagAll'..msg.chat_id_)
end
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevABD:get(JENRAL..'ABD:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "⌁︙وينكم يالربع \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevABD:get(JENRAL..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevABD:get(JENRAL..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (DevABD:get(JENRAL..'ABD:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevABD:get(JENRAL..'ABD:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevABD:get(JENRAL..'ABD:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevABD:get(JENRAL..'ABD:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevABD:get(JENRAL..'ABD:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevABD:del(JENRAL..'ABD:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevABD:del(JENRAL..'ABD:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source JENRAL     --
if text == "المطور" then 
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevABD:get(JENRAL.."ABD:ChId"))
local GetInfo = JSON.decode(Check)
local DevCh1 = GetInfo.result.username
local DevText = DevABD:get(JENRAL.."DevText")
if DevABD:get(JENRAL.."ABD:ChId") then DevCh = '\n⌁︙*Dev Ch* ↬ [@'..DevCh1..']' else DevCh = '' end
...
if not DevABD:get(JENRAL..'ABD:Lock:Stupid'..msg.chat_id_) then
...
if DevABD:sismember(JENRAL.."ABD:ABDConstructor:"..msg.chat_id_,result.id_) then
Dev_ABD(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
Dev_ABD(msg.chat_id_, result.id_, 1,''..JENRALTEAM[math.random(#JENRALTEAM)], 1, 'html') 
else  
...
if DevABD:sismember(JENRAL.."ABD:ABDConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_ABD(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local JENRALTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
Dev_ABD(msg.chat_id_, result.id_, 1,''..JENRALTEAM[math.random(#JENRALTEAM)], 1, 'md') 
end 
...
if DevABD:sismember(JENRAL..'ABD:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevABD:sismember(JENRAL..'ABD:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevABD:sismember(JENRAL..'ABD:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevABD:sismember(JENRAL..'ABD:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevABD:sismember(JENRAL..'ABD:VipAll:',result.sender_user_id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevABD:sismember(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevABD:sismember(JENRAL..'ABD:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevABD:sismember(JENRAL..'ABD:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevABD:sismember(JENRAL..'ABD:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevABD:sismember(JENRAL..'ABD:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevABD:sismember(JENRAL..'ABD:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevABD:srem(JENRAL..'ABD:SecondSudo:', result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:SudoBot:', result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:ManagerAll:', result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:AdminAll:', result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:VipAll:', result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:Managers:'..msg.chat_id_, result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:Admins:'..msg.chat_id_, result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevABD:sismember(JENRAL..'ABD:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevABD:sismember(JENRAL..'ABD:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevABD:sismember(JENRAL..'ABD:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevABD:sismember(JENRAL..'ABD:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevABD:sismember(JENRAL..'ABD:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if DevABD:sismember(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevABD:sismember(JENRAL..'ABD:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevABD:sismember(JENRAL..'ABD:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevABD:sismember(JENRAL..'ABD:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevABD:sismember(JENRAL..'ABD:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevABD:sismember(JENRAL..'ABD:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if ABDDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevABD:srem(JENRAL..'ABD:SecondSudo:', result.id_)
DevABD:srem(JENRAL..'ABD:SudoBot:', result.id_)
DevABD:srem(JENRAL..'ABD:ManagerAll:', result.id_)
DevABD:srem(JENRAL..'ABD:AdminAll:', result.id_)
DevABD:srem(JENRAL..'ABD:VipAll:', result.id_)
DevABD:srem(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,result.id_)
DevABD:srem(JENRAL..'ABD:Constructor:'..msg.chat_id_,result.id_)
DevABD:srem(JENRAL..'ABD:Managers:'..msg.chat_id_, result.id_)
DevABD:srem(JENRAL..'ABD:Admins:'..msg.chat_id_, result.id_)
DevABD:srem(JENRAL..'ABD:VipMem:'..msg.chat_id_, result.id_)
DevABD:srem(JENRAL..'ABD:Cleaner:'..msg.chat_id_, result.id_)
elseif ABDDelAll(msg.sender_user_id_,msg.chat_id_) == 'secondsudo' then
DevABD:srem(JENRAL..'ABD:SudoBot:', result.id_)
DevABD:srem(JENRAL..'ABD:ManagerAll:', result.id_)
DevABD:srem(JENRAL..'ABD:AdminAll:', result.id_)
...
DevABD:sadd(JENRAL..'ABD:SecondSudo:',result.sender_user_id_)
...
if result.id_ then
DevABD:sadd(JENRAL..'ABD:SecondSudo:',result.id_)
...
DevABD:sadd(JENRAL..'ABD:SecondSudo:',user)
...
DevABD:srem(JENRAL..'ABD:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevABD:sadd(JENRAL..'ABD:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevABD:sadd(JENRAL..'ABD:SudoBot:',result.id_)
...
DevABD:sadd(JENRAL..'ABD:SudoBot:',user)
...
DevABD:srem(JENRAL..'ABD:SudoBot:',user)
...
DevABD:sadd(JENRAL..'ABD:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevABD:sadd(JENRAL..'ABD:ManagerAll:',result.id_)
...
DevABD:sadd(JENRAL..'ABD:ManagerAll:',user)
...
DevABD:srem(JENRAL..'ABD:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevABD:sadd(JENRAL..'ABD:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevABD:sadd(JENRAL..'ABD:AdminAll:',result.id_)
...
DevABD:sadd(JENRAL..'ABD:AdminAll:',user)
...
DevABD:srem(JENRAL..'ABD:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevABD:sadd(JENRAL..'ABD:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevABD:sadd(JENRAL..'ABD:VipAll:',result.id_)
...
DevABD:sadd(JENRAL..'ABD:VipAll:',user)
...
DevABD:srem(JENRAL..'ABD:VipAll:',user)
...
function raf_reply(extra, result, success)
DevABD:sadd(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevABD:sadd(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_,result.id_)
...
DevABD:sadd(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_,user)
...
DevABD:srem(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_,result.sender_user_id_)
...
DevABD:srem(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_,result.id_)
...
DevABD:srem(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
DevABD:sadd(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevABD:sadd(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevABD:sadd(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,user)
...
DevABD:srem(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
DevABD:sadd(JENRAL..'ABD:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevABD:sadd(JENRAL..'ABD:Constructor:'..msg.chat_id_,result.id_)
...
DevABD:sadd(JENRAL..'ABD:Constructor:'..msg.chat_id_,user)
...
DevABD:srem(JENRAL..'ABD:Constructor:'..msg.chat_id_,user)
...
DevABD:sadd(JENRAL..'ABD:Managers:'..msg.chat_id_,user)
...
DevABD:srem(JENRAL..'ABD:Managers:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
DevABD:sadd(JENRAL..'ABD:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevABD:sadd(JENRAL..'ABD:Cleaner:'..msg.chat_id_,result.id_)
...
DevABD:sadd(JENRAL..'ABD:Cleaner:'..msg.chat_id_,user)
...
DevABD:srem(JENRAL..'ABD:Cleaner:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and DevABD:get(JENRAL.."ABD:Lock:ProSet"..msg.chat_id_) then 
...
DevABD:sadd(JENRAL..'ABD:Admins:'..msg.chat_id_,user)
...
DevABD:srem(JENRAL..'ABD:Admins:'..msg.chat_id_,user)
...
DevABD:sadd(JENRAL..'ABD:VipMem:'..msg.chat_id_,user)
...
DevABD:srem(JENRAL..'ABD:VipMem:'..msg.chat_id_,user)
...
DevABD:del(JENRAL.."ABD:Lock:ProSet"..msg.chat_id_)
...
DevABD:set(JENRAL.."ABD:Lock:ProSet"..msg.chat_id_,"true")
...
if not Constructor(msg) and DevABD:get(JENRAL.."ABD:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevABD:sadd(JENRAL..'ABD:Ban:'..msg.chat_id_, result.sender_user_id_)
...
ChatKick(msg.chat_id_, result.id_)
DevABD:sadd(JENRAL..'ABD:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevABD:sadd(JENRAL..'ABD:Ban:'..msg.chat_id_, user)
...
DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_, result.id_)
...
DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_, user)
...
if not Constructor(msg) and DevABD:get(JENRAL.."ABD:Lock:MuteTked"..msg.chat_id_) then 
...
if DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙هو بالفعل مكتوم من المجموعه")  
else
DevABD:sadd(JENRAL..'ABD:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⌁︙هو بالفعل مكتوم من المجموعه")  
else
DevABD:sadd(JENRAL..'ABD:Muted:'..msg.chat_id_, result.id_)
...
if DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⌁︙هو بالفعل مكتوم من المجموعه")  
else
DevABD:sadd(JENRAL..'ABD:Muted:'..msg.chat_id_, user)
...
if not DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙هو ليس مكتوم لالغاء كتمه")  
else
DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⌁︙هو ليس مكتوم لالغاء كتمه")  
else
DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_, result.id_)
...
if not DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⌁︙هو ليس مكتوم لالغاء كتمه")  
else
DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_, user)
...
DevABD:sadd(JENRAL..'ABD:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevABD:sadd(JENRAL..'ABD:Tkeed:'..msg.chat_id_, result.id_)
...
DevABD:sadd(JENRAL..'ABD:Tkeed:'..msg.chat_id_, user)
...
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_, result.id_)
...
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_, user)
...
if DevABD:sismember(JENRAL..'ABD:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevABD:sadd(JENRAL..'ABD:BanAll:', result.sender_user_id_)
...
if DevABD:sismember(JENRAL..'ABD:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevABD:sadd(JENRAL..'ABD:BanAll:', result.id_)
...
if DevABD:sismember(JENRAL..'ABD:SecondSudo:',user) and not Sudo(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevABD:sadd(JENRAL..'ABD:BanAll:', user)
...
DevABD:sadd(JENRAL..'ABD:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevABD:sadd(JENRAL..'ABD:MuteAll:', result.id_)
...
DevABD:sadd(JENRAL..'ABD:MuteAll:', user)
...
DevABD:srem(JENRAL..'ABD:BanAll:', result.sender_user_id_)
DevABD:srem(JENRAL..'ABD:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevABD:srem(JENRAL..'ABD:BanAll:', result.id_)
DevABD:srem(JENRAL..'ABD:MuteAll:', result.id_)
...
DevABD:srem(JENRAL..'ABD:BanAll:', user)
DevABD:srem(JENRAL..'ABD:MuteAll:', user)
...
DevABD:setex(JENRAL.."ABD:EditDev"..msg.sender_user_id_,300,true)
end
if DevABD:get(JENRAL.."ABD:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'⌁︙تم الغاء امر تغير المطور الاساسي')
DevABD:del(JENRAL.."ABD:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevABD:del(JENRAL.."ABD:EditDev"..msg.sender_user_id_)
DevABD:set(JENRAL.."ABD:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source JENRAL     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevABD:get(JENRAL..'ABD:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevABD:sismember(JENRAL..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙تم رفعه في قائمة المطايه") 
DevABD:sadd(JENRAL..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source JENRAL     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevABD:get(JENRAL..'ABD:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevABD:sismember(JENRAL..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⌁︙هو ليس مطي ليتم تنزيله") 
else
DevABD:srem(JENRAL..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevABD:set('JENRALTEAM:'..JENRAL..'id:user'..msg.chat_id_,TXT)  
DevABD:setex('JENRALTEAM:'..JENRAL.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevABD:del(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevABD:incrby(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevABD:set('JENRALTEAM:'..JENRAL..'ids:user'..msg.chat_id_,TXT)  
DevABD:setex('JENRALTEAM:'..JENRAL.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevABD:incrby(JENRAL..'ABD:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevABD:get(JENRAL..'ABD:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then DevABD:sadd(JENRAL.."ABD:cleaner"..msg.chat_id_, msg.id_) else DevABD:sadd(JENRAL.."ABD:cleaner"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevABD:sismember(JENRAL.."ABD:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevABD:set(JENRAL..'ABD:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevABD:smembers(JENRAL..'ABD:VipMem:'..msg.chat_id_)
text = "⌁︙قائمة المميزين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevABD:get(JENRAL..'Save:UserName'..v)
if username then
...
local List = DevABD:smembers(JENRAL..ABD)
text = "⌁︙قائمة الادمنيه ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevABD:get(JENRAL..'Save:UserName'..v)
if username then
...
local List = DevABD:smembers(JENRAL..'ABD:Managers:'..msg.chat_id_)
text = "⌁︙قائمة المدراء ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevABD:get(JENRAL..'Save:UserName'..v)
if username then
...
local List = DevABD:smembers(JENRAL..'ABD:Cleaner:'..msg.chat_id_)
text = "⌁︙قائمة المنظفين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevABD:get(JENRAL..'Save:UserName'..v)
if username then
...
local List = DevABD:smembers(JENRAL..'ABD:Constructor:'..msg.chat_id_)
text = "⌁︙قائمة المنشئين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevABD:get(JENRAL..'Save:UserName'..v)
if username then
...
local List = DevABD:smembers(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_)
text = "⌁︙قائمة المالكين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevABD:get(JENRAL..'Save:UserName'..v)
if username then
...
local List = DevABD:smembers(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_)
...
local List = DevABD:smembers(JENRAL..'ABD:Muted:'..msg.chat_id_)
...
local List = DevABD:smembers(JENRAL..'ABD:Tkeed:'..msg.chat_id_)
text = "⌁︙قائمة المقيدين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local username = DevABD:get(JENRAL..'Save:UserName'..v)
if username then
...
local List = DevABD:smembers(JENRAL..'ABD:Ban:'..msg.chat_id_)
...
local List = DevABD:hkeys(JENRAL..'ABD:Filters:'..msg.chat_id_)
text = "⌁︙قائمة المنع ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevABD:smembers(JENRAL..'User:Donky:'..msg.chat_id_)
...
local List = DevABD:smembers(JENRAL..'ABD:SecondSudo:')
...
local BanAll = DevABD:smembers(JENRAL..'ABD:BanAll:')
local MuteAll = DevABD:smembers(JENRAL..'ABD:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevABD:smembers(JENRAL..'ABD:SudoBot:')
text = "⌁︙قائمة المطورين ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
for k,v in pairs(List) do
local sudouser = DevABD:get(JENRAL..'ABD:Sudos'..v) 
local username = DevABD:get(JENRAL..'Save:UserName'..v)
if username then
...
local List = DevABD:smembers(JENRAL..'ABD:ManagerAll:')
...
local List = DevABD:smembers(JENRAL..'ABD:VipAll:')
...
DevABD:sadd(JENRAL.."ABD:ABDConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevABD:srem(JENRAL.."ABD:FilterSteckr"..msg.chat_id_,idsticker)
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevABD:srem(JENRAL.."ABD:FilterPhoto"..msg.chat_id_,photo)
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevABD:srem(JENRAL.."ABD:FilterAnimation"..msg.chat_id_,idanimation)
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Thwel:ABD'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل تحويل الصيغ'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Thwel:ABD'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevABD:get(JENRAL..'ABD:Thwel:ABD'..msg.chat_id_) and SourceCh(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevABD:get(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevABD:sismember(JENRAL..'ABD:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevABD:sismember(JENRAL..'ABD:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevABD:sismember(JENRAL..'ABD:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevABD:sismember(JENRAL..'ABD:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevABD:sismember(JENRAL..'ABD:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n⌁︙عدد الكروبات ↫ '..(DevABD:get(JENRAL..'ABD:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevABD:get(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevABD:sismember(JENRAL..'ABD:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevABD:sismember(JENRAL..'ABD:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevABD:sismember(JENRAL..'ABD:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevABD:sismember(JENRAL..'ABD:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevABD:sismember(JENRAL..'ABD:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n⌁︙عدد الكروبات ↫ '..(DevABD:get(JENRAL..'ABD:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevABD:get(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevABD:sismember(JENRAL..'ABD:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevABD:sismember(JENRAL..'ABD:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevABD:sismember(JENRAL..'ABD:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevABD:sismember(JENRAL..'ABD:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevABD:sismember(JENRAL..'ABD:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n⌁︙عدد الكروبات ↫ '..(DevABD:get(JENRAL..'ABD:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevABD:sismember(JENRAL..'ABD:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevABD:sismember(JENRAL..'ABD:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevABD:sismember(JENRAL..'ABD:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevABD:sismember(JENRAL..'ABD:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevABD:sismember(JENRAL..'ABD:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevABD:sismember(JENRAL..'ABD:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevABD:sismember(JENRAL..'ABD:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevABD:sismember(JENRAL..'ABD:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevABD:sismember(JENRAL..'ABD:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙الحظر العام ↫ '..banall..'\n⌁︙الكتم العام ↫ '..muteall..'\n⌁︙الحظر ↫ '..banned..'\n⌁︙الكتم ↫ '..muted..'\n⌁︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_,result.sender_user_id_) DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_,result.sender_user_id_) DevABD:srem(JENRAL..'ABD:BanAll:',result.sender_user_id_) DevABD:srem(JENRAL..'ABD:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_,result.sender_user_id_) DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_,user) DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_,user) DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_,user) DevABD:srem(JENRAL..'ABD:BanAll:',user) DevABD:srem(JENRAL..'ABD:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_,user) DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_,user) DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_,result.id_) DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_,result.id_) DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_,result.id_) DevABD:srem(JENRAL..'ABD:BanAll:',result.id_) DevABD:srem(JENRAL..'ABD:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_,result.id_) DevABD:srem(JENRAL..'ABD:Ban:'..msg.chat_id_,result.id_) DevABD:srem(JENRAL..'ABD:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevABD:set(JENRAL.."ABD:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevABD:set("JENRAL:New:id:"..JENRAL..msg.sender_user_id_,'JENRALTEAM')
return "JENRALTEAM"
end
if text and DevABD:get("JENRAL:New:id:"..JENRAL..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevABD:del("JENRAL:New:id:"..JENRAL..msg.sender_user_id_)
return false
end
DevABD:del("JENRAL:New:id:"..JENRAL..msg.sender_user_id_)
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevABD:set(JENRAL.."ABD:AllIds:Text",text)
return false
end
...
DevABD:del(JENRAL.."ABD:AllIds:Text")
end
end
--     Source JENRAL     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙رجائا اتبع التعليمات للتعيين \n⌁︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
DevABD:set("JENRAL:New:id:"..JENRAL..msg.chat_id_..msg.sender_user_id_,'JENRALTEAM')
return "JENRALTEAM"
end
if text and Manager(msg) and DevABD:get("JENRAL:New:id:"..JENRAL..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevABD:del("JENRAL:New:id:"..JENRAL..msg.chat_id_..msg.sender_user_id_)
return false
end
DevABD:del("JENRAL:New:id:"..JENRAL..msg.chat_id_..msg.sender_user_id_)
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم حفظ الكليشه الجديده', 1, 'md')
DevABD:set(JENRAL.."ABD:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف كليشة الايدي")  
DevABD:del(JENRAL.."ABD:GpIds:Text"..msg.chat_id_)
end
end
--     Source JENRAL     --
if msg.reply_to_message_id_ ~= 0 then
...
local msgsday = DevABD:get(JENRAL..'ABD:UsersMsgs'..JENRAL..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevABD:get(JENRAL..'ABD:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevABD:get(JENRAL..'ABD:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevABD:get(JENRAL..'ABD:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevABD:get(JENRAL..'ABD:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevABD:get(JENRAL..'ABD:Lock:Id'..msg.chat_id_) then 
if not DevABD:get(JENRAL..'ABD:Lock:Id:Photo'..msg.chat_id_) then 
if DevABD:get(JENRAL.."ABD:AllIds:Text") then
newpicid = DevABD:get(JENRAL.."ABD:AllIds:Text")
...
if not DevABD:get(JENRAL.."ABD:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, abbas.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevABD:get(JENRAL.."ABD:GpIds:Text"..msg.chat_id_)
...
if DevABD:get(JENRAL.."ABD:AllIds:Text") then
newallid = DevABD:get(JENRAL.."ABD:AllIds:Text")
...
if DevABD:get(JENRAL.."ABD:AllIds:Text") then
notpicid = DevABD:get(JENRAL.."ABD:AllIds:Text")
...
if not DevABD:get(JENRAL..'ABD:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التعديل")  
DevABD:set(JENRAL..'ABD:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevABD:set(JENRAL.."ABD:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevABD:hset(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevABD:hset(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevABD:hset(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevABD:hset(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevABD:get(JENRAL..'ABD:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevABD:set(JENRAL.."ABD:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم قفل التثبيت")  
DevABD:set(JENRAL..'ABD:Lock:Pin'..msg.chat_id_,true)
DevABD:sadd(JENRAL.."ABD:Lock:Pinpin",msg.chat_id_) 
else
...
DevABD:hset(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevABD:hset(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevABD:get(JENRAL..'ABD:Lock:Id:Photo'..msg.chat_id_) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل الايدي بالصوره'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevABD:get(JENRAL..'ABD:Lock:Id'..msg.chat_id_) then
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙الايدي بالتاكيد معطل ', 1, 'md')
else
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل الايدي بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source JENRAL     --
...
DevABD:setex(JENRAL.."ABD:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' or text == 'انشاء الرابط' then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevABD:get(JENRAL.."ABD:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevABD:set(JENRAL.."ABD:Groups:Links"..msg.chat_id_,LinkGroup) 
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL.."ABD:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل الترحيب بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL.."ABD:Lock:Welcome"..msg.chat_id_)
end
if DevABD:get(JENRAL..'ABD:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevABD:del(JENRAL..'ABD:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevABD:del(JENRAL..'ABD:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevABD:set(JENRAL..'ABD:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevABD:set(JENRAL..'ABD:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف الترحيب")  
DevABD:del(JENRAL..'ABD:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevABD:get(JENRAL..'ABD:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_ABD(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source JENRAL     --
if DevABD:get(JENRAL..'ABD:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء حفظ الوصف", 1, 'md')
DevABD:del(JENRAL..'ABD:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevABD:del(JENRAL..'ABD:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevABD:set(JENRAL..'ABD:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevABD:set(JENRAL.."ABD:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevABD:get(JENRAL.."ABD:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر المنع', 1, 'md')
DevABD:del(JENRAL.."ABD:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم منع الكلمه ↫ "..text, 1, 'html')
DevABD:del(JENRAL.."ABD:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevABD:hset(JENRAL..'ABD:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙ارسل لي الكلمه الان", 1, 'md') 
DevABD:set(JENRAL.."ABD:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevABD:get(JENRAL.."ABD:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر الغاء المنع', 1, 'md')
DevABD:del(JENRAL.."ABD:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevABD:hget(JENRAL..'ABD:Filters:'..msg.chat_id_, text) then  
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevABD:del(JENRAL.."ABD:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevABD:hdel(JENRAL..'ABD:Filters:'..msg.chat_id_, text)
...
local gps = DevABD:scard(JENRAL.."ABD:Groups") local users = DevABD:scard(JENRAL.."ABD:Users") 
...
local users = DevABD:scard(JENRAL.."ABD:Users")
...
local gps = DevABD:scard(JENRAL.."ABD:Groups")
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
end
--     Source JENRAL     --
if text and text:match('^تنظيف (%d+)$') and ChCheck(msg) then  
if not DevABD:get(JENRAL..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevABD:setex(JENRAL..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
if text == "تنظيف المشتركين" and SecondSudo(msg) and ChCheck(msg) then 
local pv = DevABD:smembers(JENRAL.."ABD:Users")
local sendok = 0
for i = 1, #pv do
...
DevABD:srem(JENRAL.."ABD:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevABD:smembers(JENRAL.."ABD:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevABD:srem(JENRAL.."ABD:Groups",group[i]) 
...
Dev_ABD(msg.chat_id_, msg.id_, 1,'⌁︙عدد الكروبات الان ↫ { '..#group..' }'..JENRALgp1..JENRALgp2..'\n⌁︙العدد الحقيقي الان  ↫ ( '..JENRALgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:Clean'..msg.chat_id_,true)  
end
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:Clean'..msg.chat_id_) 
end
...
DevABD:set(JENRAL..'ABD:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevABD:get(JENRAL..'ABD:Lock:Clean'..msg.chat_id_) then
if DevABD:get(JENRAL..'ABD:CleanNum'..msg.chat_id_) then CleanNum = DevABD:get(JENRAL..'ABD:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevABD:scard(JENRAL.."ABD:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevABD:smembers(JENRAL.."ABD:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
DevABD:del(JENRAL.."ABD:cleaner"..msg.chat_id_)
end 
end 
if Cleaner(msg) then
if DevABD:get(JENRAL..'ABD:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevABD:scard(JENRAL.."ABD:cleaner"..msg.chat_id_)
if M ~= 0 then
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙عدد الميديا ↫ "..M.."\n⌁︙الحذف التلقائي ↫ "..(DevABD:get(JENRAL..'ABD:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
if DevABD:get(JENRAL..'ABD:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم فتح التعديل")  
DevABD:del(JENRAL..'ABD:Lock:EditMsgs'..msg.chat_id_)
else
...
DevABD:del(JENRAL.."ABD:Lock:Bots"..msg.chat_id_)  
end
if UnLockText[2] == "التكرار" then 
DevABD:hdel(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevABD:get(JENRAL..'ABD:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم فتح التثبيت")  
DevABD:del(JENRAL..'ABD:Lock:Pin'..msg.chat_id_)
DevABD:srem(JENRAL.."ABD:Lock:Pinpin",msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Text'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Photo'..msg.chat_id_)
else
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevABD:get(JENRAL..'ABD:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم فتح الكلايش")  
DevABD:del(JENRAL..'ABD:Lock:Spam'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Join'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Videos'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Document'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Inline'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Markdown'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Gifs'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Music'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Voice'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Links'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Location'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Tags'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Hashtak'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Contact'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:WebLinks'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Arabic'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:English'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:TagServr'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Stickers'..msg.chat_id_)
else
...
DevABD:del(JENRAL..'ABD:Lock:Forwards'..msg.chat_id_)
else
...
DevABD:set(JENRAL.."ABD:Lock:Bots"..msg.chat_id_,"del") DevABD:hset(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'ABD:Lock:Links','ABD:Lock:Contact','ABD:Lock:Forwards','ABD:Lock:Videos','ABD:Lock:Gifs','ABD:Lock:EditMsgs','ABD:Lock:Stickers','ABD:Lock:Farsi','ABD:Lock:Spam','ABD:Lock:WebLinks','ABD:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevABD:set(JENRAL..Lock..msg.chat_id_,true)
end
...
DevABD:del(JENRAL..UnLock..msg.chat_id_)
end
...
DevABD:del(JENRAL..'ABD:Lock:Fshar'..msg.chat_id_) DevABD:del(JENRAL..'ABD:Lock:Taf'..msg.chat_id_) DevABD:del(JENRAL..'ABD:Lock:Kfr'..msg.chat_id_) 
DevABD:set(JENRAL.."ABD:Lock:Bots"..msg.chat_id_,"del") DevABD:hset(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevABD:set(JENRAL..'ABD:Lock:Fshar'..msg.chat_id_,true) DevABD:set(JENRAL..'ABD:Lock:Taf'..msg.chat_id_,true) DevABD:set(JENRAL..'ABD:Lock:Kfr'..msg.chat_id_,true) DevABD:hdel(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevABD:set(JENRAL..'ABD:Spam:Text'..msg.chat_id_,SetSpam)
...
DevABD:del(JENRAL.."ABD:mem:Rd"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:Cleaner:Rd"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:VipMem:Rd"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:Admins:Rd"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:Managers:Rd"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:Constructor:Rd"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:BasicConstructor:Rd"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source JENRAL     --
...
DevABD:del(JENRAL..'ABD:AdminAll:')
end
...
DevABD:del(JENRAL..'ABD:ManagerAll:')
end
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
DevABD:del(JENRAL..'ABD:ABDConstructor:'..msg.chat_id_)
...
DevABD:del(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف المنشئين")  
DevABD:del(JENRAL..'ABD:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف المدراء")  
DevABD:del(JENRAL..'ABD:Managers:'..msg.chat_id_)
end 
...
DevABD:srem(JENRAL..'ABD:Tkeed:'..msg.chat_id_, v)
end 
...
DevABD:del(JENRAL..'ABD:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⌁︙تم حذف قوائم المنع")  
DevABD:del(JENRAL..'ABD:Filters:'..msg.chat_id_)
DevABD:del(JENRAL.."ABD:FilterAnimation"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:FilterPhoto"..msg.chat_id_)
DevABD:del(JENRAL.."ABD:FilterSteckr"..msg.chat_id_)
end
...
DevABD:del(JENRAL..'ABD:Ban:'..msg.chat_id_) DevABD:del(JENRAL..'ABD:Admins:'..msg.chat_id_) DevABD:del(JENRAL..'User:Donky:'..msg.chat_id_) DevABD:del(JENRAL..'ABD:VipMem:'..msg.chat_id_) DevABD:del(JENRAL..'ABD:Filters:'..msg.chat_id_) DevABD:del(JENRAL..'ABD:Muted:'..msg.chat_id_)
...
local basicconstructor = DevABD:smembers(JENRAL..'ABD:BasicConstructor:'..msg.chat_id_)
local constructor = DevABD:smembers(JENRAL..'ABD:Constructor:'..msg.chat_id_)
local Managers = DevABD:smembers(JENRAL..'ABD:Managers:'..msg.chat_id_)
local admins = DevABD:smembers(JENRAL..'ABD:Admins:'..msg.chat_id_)
local vipmem = DevABD:smembers(JENRAL..'ABD:VipMem:'..msg.chat_id_)
local donky = DevABD:smembers(JENRAL..'User:Donky:'..msg.chat_id_)
...
spam_c = DevABD:get(JENRAL..'ABD:Spam:Text'..msg.chat_id_)
end
--     Source JENRAL     --
if DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source JENRAL     --
if DevABD:get(JENRAL.."ABD:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevABD:get(JENRAL.."ABD:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevABD:get(JENRAL.."ABD:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source JENRAL     --
if DevABD:get(JENRAL..'ABD:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevABD:get(JENRAL..'ABD:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevABD:get(JENRAL.."ABD:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevABD:get(JENRAL..'ABD:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevABD:get(JENRAL..'ABD:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevABD:get(JENRAL..'ABD:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevABD:get(JENRAL..'ABD:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevABD:hget(JENRAL.."ABD:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source JENRAL     --
...
--     Source JENRAL     --
if DevABD:get(JENRAL..'ABD:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevABD:del(JENRAL..'ABD:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevABD:del(JENRAL..'ABD:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:rules'..msg.chat_id_,text)
...
DevABD:set(JENRAL..'ABD:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") then
local rules = DevABD:get(JENRAL..'ABD:rules'..msg.chat_id_)
...
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل ميزة انطق'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Antk:ABD'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل ميزة انطق'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Antk:ABD'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevABD:get(JENRAL..'ABD:Antk:ABD'..msg.chat_id_) and SourceCh(msg) then
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Zrf:ABD'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل الزخرفه بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Zrf:ABD'..msg.chat_id_,true)  
end
if DevABD:get(JENRAL..'Zrf:ABD'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر الزخرفه', 1, 'md')
DevABD:del(JENRAL..'Zrf:ABD'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevABD:get(JENRAL..'ABD:Zrf:ABD'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevABD:setex(JENRAL.."Zrf:ABD"..msg.chat_id_..msg.sender_user_id_,300,true)
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Brg:ABD'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل الابراج بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Brg:ABD'..msg.chat_id_,true)  
end
if not DevABD:get(JENRAL..'ABD:Brg:ABD'..msg.chat_id_) then
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Nsba:ABD'..msg.chat_id_) 
end
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Nsba:ABD'..msg.chat_id_,true)  
end
if not DevABD:get(JENRAL..'ABD:Nsba:ABD'..msg.chat_id_) then
if text == "نسبه الحب" and SourceCh(msg) or text == "نسبة الحب" and SourceCh(msg) then
DevABD:set(JENRAL..'LoveNsba:ABD'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevABD:get(JENRAL..'LoveNsba:ABD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الحب ', 1, 'md')
DevABD:del(JENRAL..'LoveNsba:ABD'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevABD:set(JENRAL..'HataNsba:ABD'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and DevABD:get(JENRAL..'HataNsba:ABD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الكره ', 1, 'md')
DevABD:del(JENRAL..'HataNsba:ABD'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ABD = math.random(0,100);
...
DevABD:set(JENRAL..'RjolaNsba:ABD'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and DevABD:get(JENRAL..'RjolaNsba:ABD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevABD:del(JENRAL..'RjolaNsba:ABD'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ABD = math.random(0,100);
...
DevABD:set(JENRAL..'AnothaNsba:ABD'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and DevABD:get(JENRAL..'AnothaNsba:ABD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevABD:del(JENRAL..'AnothaNsba:ABD'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ABD = math.random(0,100);
...
DevABD:set(JENRAL..'StupidNsba:ABD'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and DevABD:get(JENRAL..'StupidNsba:ABD'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevABD:del(JENRAL..'StupidNsba:ABD'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
ABD = math.random(0,100);
...
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل حساب العمر'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Age:ABD'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل حساب العمر'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Age:ABD'..msg.chat_id_,true)  
end
if not DevABD:get(JENRAL..'ABD:Age:ABD'..msg.chat_id_) then
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Mean:ABD'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل معاني الاسماء'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Mean:ABD'..msg.chat_id_,true)  
end
if not DevABD:get(JENRAL..'ABD:Mean:ABD'..msg.chat_id_) then
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Audios:ABD'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل غنيلي بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Audios:ABD'..msg.chat_id_,true)  
end
if text == "غنيلي" and not DevABD:get(JENRAL..'ABD:Audios:ABD'..msg.chat_id_) and SourceCh(msg) then
...
{{text = '⌁ JENRAL TeAM .',url="t.me/TNNN7"}},
}
...
--     Source JENRAL     --
if Admin(msg) then
if DevABD:get(JENRAL..'ABD:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevABD:get(JENRAL..'ABD:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الروابط ↫ "..mute_links.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevABD:get(JENRAL..'ABD:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙المعرف ↫ "..lock_tag.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevABD:get(JENRAL..'ABD:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙المتحركه ↫ "..mute_gifs.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الملصقات" then if DevABD:get(JENRAL..'ABD:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الملصقات ↫ "..lock_sticker.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الصور" then if DevABD:get(JENRAL..'ABD:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الصور ↫ "..mute_photo.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevABD:get(JENRAL..'ABD:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الفيديو ↫ "..mute_video.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الاونلاين" then if DevABD:get(JENRAL..'ABD:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local JENRALTEAM = "\n" .."⌁︙الاونلاين ↫ "..mute_in.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الدردشه" then if DevABD:get(JENRAL..'ABD:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الدردشه ↫ "..mute_text.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevABD:get(JENRAL..'ABD:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local JENRALTEAM = "\n" .."⌁︙التوجيه ↫ "..lock_forward.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الاغاني" then if DevABD:get(JENRAL..'ABD:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الاغاني ↫ "..mute_music.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevABD:get(JENRAL..'ABD:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local JENRALTEAM = "\n" .."⌁︙الصوت ↫ "..mute_voice.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevABD:get(JENRAL..'ABD:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الجهات ↫ "..lock_contact.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الماركداون" then if DevABD:get(JENRAL..'ABD:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local JENRALTEAM = "\n" .."⌁︙الماركداون ↫ "..markdown.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الهاشتاك" then if DevABD:get(JENRAL..'ABD:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local JENRALTEAM = "\n" .."⌁︙الهاشتاك ↫ "..lock_htag.."\n"Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "التعديل" then if DevABD:get(JENRAL..'ABD:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local JENRALTEAM = "\n" .."⌁︙التعديل ↫ "..mute_edit.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "التثبيت" then if DevABD:get(JENRAL..'ABD:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local JENRALTEAM = "\n" .."⌁︙التثبيت ↫ "..lock_pin.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الاشعارات" then if DevABD:get(JENRAL..'ABD:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الكلايش" then if DevABD:get(JENRAL..'ABD:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الكلايش ↫ "..lock_spam.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الدخول" then if DevABD:get(JENRAL..'ABD:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local JENRALTEAM = "\n" .."⌁︙الدخول ↫ "..lock_Join.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الشبكات" then if DevABD:get(JENRAL..'ABD:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الشبكات ↫ "..lock_wp.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "المواقع" then if DevABD:get(JENRAL..'ABD:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙المواقع ↫ "..lock_location.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "العربيه" then if DevABD:get(JENRAL..'ABD:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙العربيه ↫ "..lock_arabic.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الانكليزيه" then if DevABD:get(JENRAL..'ABD:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local JENRALTEAM = "\n" .."⌁︙الانكليزيه ↫ "..lock_english.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الكفر" then if DevABD:get(JENRAL..'ABD:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local JENRALTEAM = "\n" .."⌁︙الكفر ↫ "..lock_kaf.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الفشار" then if DevABD:get(JENRAL..'ABD:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local JENRALTEAM = "\n" .."⌁︙الفشار ↫ "..lock_fshar.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
if text == "الطائفيه" then if DevABD:get(JENRAL..'ABD:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local JENRALTEAM = "\n" .."⌁︙الطائفيه ↫ "..lock_taf.."\n" Dev_ABD(msg.chat_id_, msg.id_, 1, JENRALTEAM, 1, 'md') end
end
--     Source JENRAL     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل كشف الاعدادات'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل كشف الاعدادات'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:LockSettings'..msg.chat_id_) 
end
--     Source JENRAL     --
if text == 'تفعيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل اوامر التحشيش'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل اوامر التحشيش'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:Stupid'..msg.chat_id_,true)
end
--     Source JENRAL     --
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:Robot'..msg.chat_id_)
end
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:Robot'..msg.chat_id_,true)
end
--     Source JENRAL     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل ردود المدير'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل ردود المدير'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:GpRed'..msg.chat_id_,true)
end
--     Source JENRAL     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل ردود المطور'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل ردود المطور'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:AllRed'..msg.chat_id_,true)
end
--     Source JENRAL     --
if SecondSudo(msg) then
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL.."ABD:Left:Bot"..JENRAL)
end
if text == 'تعطيل المغادره' or text == '↫ تعطيل المغادره ⌁' then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل المغادره بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL.."ABD:Left:Bot"..JENRAL,true) 
end 
if text == 'تفعيل الاذاعه' or text == '↫ تفعيل الاذاعه ⌁' then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل الاذاعه بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL.."ABD:Send:Bot"..JENRAL)
end
if text == 'تعطيل الاذاعه' or text == '↫ تعطيل الاذاعه ⌁' then 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل الاذاعه بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL.."ABD:Send:Bot"..JENRAL,true) 
end
end
--     Source JENRAL     --
...
--     Source JENRAL     --
if msg.content_.photo_ then
if DevABD:get(JENRAL..'ABD:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevABD:del(JENRAL..'ABD:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"⌁︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevABD:del(JENRAL..'ABD:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevABD:set(JENRAL..'ABD:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source JENRAL     --
...
if data.ID == "Ok" then
DevABD:del(JENRAL..'ABD:PinnedMsg'..msg.chat_id_)
...
local PinId = DevABD:get(JENRAL..'ABD:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevABD:del(JENRAL..'ABD:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevABD:scard(JENRAL.."ABD:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevABD:scard(JENRAL.."ABD:Constructor:"..ChatId) or 0
local BanedList = DevABD:scard(JENRAL.."ABD:Ban:"..ChatId) or 0
local ManagerList = DevABD:scard(JENRAL.."ABD:Managers:"..ChatId) or 0
local MutedList = DevABD:scard(JENRAL.."ABD:Muted:"..ChatId) or 0
local TkeedList = DevABD:scard(JENRAL.."ABD:ABD:Tkeed:"..ChatId) or 0
local AdminsList = DevABD:scard(JENRAL.."ABD:Admins:"..ChatId) or 0
local VipList = DevABD:scard(JENRAL.."ABD:VipMem:"..ChatId) or 0
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..ChatId))
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/TNNN7' end
...
ConstructorABD = "["..ABD.first_name_.."](T.me/"..(ABD.username_ or "TNNN7")..")"
else 
...
DevABD:srem(JENRAL.."ABD:Groups", dp.id_)
else
...
DevABD:set(JENRAL..'ABD:Num:Add:Bot',Num) 
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:FreeBot'..JENRAL) 
end 
end
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:FreeBot'..JENRAL,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL..'ABD:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تعطيل الالعاب بنجاح'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL..'ABD:Lock:Games'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" or text == "تفعيل جلب الرابط" then 
if Admin(msg) then
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙تم تفعيل جلب رابط المجموعه'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:del(JENRAL.."ABD:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
...
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
DevABD:set(JENRAL.."ABD:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
--     Source JENRAL     --
...
ReplyStatus(msg,result.id_,"ReplyBy","⌁︙تم تفعيل المجموعه "..dp.title_)  
DevABD:sadd(JENRAL.."ABD:Groups",msg.chat_id_)
if not DevABD:get(JENRAL..'ABD:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevABD:incrby(JENRAL..'ABD:Sudos'..msg.sender_user_id_,1)
DevABD:set(JENRAL..'ABD:SudosGp'..msg.sender_user_id_..msg.chat_id_,"ABD")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevABD:sismember(JENRAL..'ABD:Groups',msg.chat_id_) then
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './JENRAL.lua', '⌁︙نسخة ملف سورس جنرال ',dl_cb, nil)
end end
--     Source JENRAL     --
...
for k,v in pairs(List) do
local GroupsManagers = DevABD:scard(JENRAL.."ABD:Managers:"..v) or 0
local GroupsAdmins = DevABD:scard(JENRAL.."ABD:Admins:"..v) or 0
local Groupslink = DevABD:get(JENRAL.."ABD:Groups:Links" ..v)
...
DevABD:setex(JENRAL.."ABD:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⌁︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevABD:get(JENRAL.."ABD:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevABD:del(JENRAL.."ABD:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevABD:smembers(JENRAL..'ABD:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
ABDText = "الرساله"
...
DevABD:setex(JENRAL.."ABD:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⌁︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevABD:get(JENRAL.."ABD:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevABD:del(JENRAL.."ABD:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevABD:smembers(JENRAL..'ABD:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
ABDText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevABD:setex(JENRAL.."ABD:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙ارسل الرساله الان لتوجيها \n⌁︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevABD:get(JENRAL.."ABD:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevABD:del(JENRAL.."ABD:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevABD:smembers(JENRAL..'ABD:Groups')   
for k,v in pairs(List) do  
...
DevABD:setex(JENRAL.."ABD:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙ارسل الرساله الان لتوجيها \n⌁︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevABD:get(JENRAL.."ABD:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevABD:del(JENRAL.."ABD:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevABD:smembers(JENRAL..'ABD:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم اذاعة رسالتك بالتوجيه \n⌁︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevABD:setex(JENRAL.."ABD:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local JENRALTEAM = '⌁︙اهلا عزيزي ↫ '..ABDRank(msg)..' \n⌁︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⌁︙للخروج ارسل ↫ ( الغاء ) \n ✓'
ABDmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, JENRALTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if DevABD:get(JENRAL.."ABD:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevABD:del(JENRAL.."ABD:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevABD:smembers(JENRAL.."ABD:Groups") 
if msg.content_.text_ then
...
ABDText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevABD:set(JENRAL..'ABD:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
ABDText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevABD:set(JENRAL..'ABD:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
ABDText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevABD:set(JENRAL..'ABD:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
ABDText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevABD:set(JENRAL..'ABD:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
ABDText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevABD:set(JENRAL..'ABD:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
ABDText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevABD:set(JENRAL..'ABD:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
ABDText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevABD:set(JENRAL..'ABD:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
ABDText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevABD:set(JENRAL..'ABD:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
local List = DevABD:smembers(JENRAL..'ABD:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end
DevABD:set(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevABD:get(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevABD:sismember(JENRAL..'ABD:Manager:GpRedod'..msg.chat_id_,text) then
...
DevABD:set(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevABD:set(JENRAL..'ABD:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevABD:set(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text == 'اضف رد متعدد' and Manager(msg) and ChCheck(msg) then
DevABD:set(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRedod = DevABD:get(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevABD:set(JENRAL..'ABD:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevABD:set(JENRAL..'ABD:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevABD:sadd(JENRAL..'ABD:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source JENRAL     --
if text == 'حذف رد' and Manager(msg) and ChCheck(msg) or text == 'مسح رد' and  Manager(msg) and ChCheck(msg) then
local List = DevABD:smembers(JENRAL..'ABD:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevABD:set(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد' and Manager(msg) and ChCheck(msg) then
DevABD:set(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = DevABD:get(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevABD:set(JENRAL..'ABD:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevABD:set(JENRAL..'ABD:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevABD:sadd(JENRAL..'ABD:Manager:GpRed'..msg.chat_id_,text)
DevABD:set(JENRAL..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source JENRAL     --
if text == 'حذف رد عام' and SecondSudo(msg) or text == '↫ حذف رد عام ⌁' and SecondSudo(msg) or text == 'مسح رد عام' and SecondSudo(msg) then
local List = DevABD:smembers(JENRAL.."ABD:Sudo:AllRed")
if #List == 0 then
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙لا توجد ردود مضافه" ,  1, "md")
return false
end
DevABD:set(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد عام' and SecondSudo(msg) or text == '↫ اضف رد عام ⌁' and SecondSudo(msg) then
DevABD:set(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetAllRed = DevABD:get(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_)
...
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⌁︙يمكنك اضافة الى النص ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n⌁︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevABD:set(JENRAL.."ABD:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevABD:set(JENRAL.."ABD:Add:AllText"..msg.sender_user_id_, text)
DevABD:sadd(JENRAL.."ABD:Sudo:AllRed",text)
DevABD:set(JENRAL.."DelSudoRep",text)
return false 
end end
--     Source JENRAL     --
if text == 'الردود المتعدده' and Manager(msg) and ChCheck(msg) then
local redod = DevABD:smembers(JENRAL..'ABD:Manager:GpRedod'..msg.chat_id_)
MsgRep = '⌁︙قائمة الردود المتعدده ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevABD:smembers(JENRAL..'ABD:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
for k,v in pairs(redod) do
DevABD:del(JENRAL..'ABD:Text:GpTexts'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevABD:smembers(JENRAL..'ABD:Manager:GpRed'..msg.chat_id_)
MsgRep = '⌁︙ردود المدير ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n'
for k,v in pairs(redod) do
if DevABD:get(JENRAL.."ABD:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevABD:get(JENRAL.."ABD:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevABD:get(JENRAL.."ABD:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevABD:get(JENRAL.."ABD:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevABD:get(JENRAL.."ABD:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevABD:get(JENRAL.."ABD:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevABD:get(JENRAL.."ABD:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevABD:get(JENRAL.."ABD:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevABD:del(JENRAL..'ABD:Gif:GpRed'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Voice:GpRed'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Audio:GpRed'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Photo:GpRed'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Stecker:GpRed'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Video:GpRed'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:File:GpRed'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Text:GpRed'..v..msg.chat_id_)
DevABD:del(JENRAL..'ABD:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevABD:smembers(JENRAL.."ABD:Sudo:AllRed")
MsgRep = '⌁︙ردود المطور ↫ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n'
for k,v in pairs(redod) do
if DevABD:get(JENRAL.."ABD:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevABD:get(JENRAL.."ABD:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevABD:get(JENRAL.."ABD:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevABD:get(JENRAL.."ABD:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevABD:get(JENRAL.."ABD:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevABD:get(JENRAL.."ABD:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevABD:get(JENRAL.."ABD:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevABD:get(JENRAL.."ABD:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevABD:del(JENRAL.."ABD:Add:AllRed"..v)
DevABD:del(JENRAL.."ABD:Gif:AllRed"..v)
DevABD:del(JENRAL.."ABD:Voice:AllRed"..v)
DevABD:del(JENRAL.."ABD:Audio:AllRed"..v)
DevABD:del(JENRAL.."ABD:Photo:AllRed"..v)
DevABD:del(JENRAL.."ABD:Stecker:AllRed"..v)
DevABD:del(JENRAL.."ABD:Video:AllRed"..v)
DevABD:del(JENRAL.."ABD:File:AllRed"..v)
DevABD:del(JENRAL.."ABD:Text:AllRed"..v)
DevABD:del(JENRAL.."ABD:Sudo:AllRed")
end
...
DevABD:set(JENRAL..'ABD:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevABD:set(JENRAL..'ABD:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local JENRALTEAM =  DevABD:get(JENRAL..'ABD:Help0'..msg.sender_user_id_)
if JENRALTEAM == 'msg' then
Dev_ABD(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevABD:del(JENRAL..'ABD:Help0'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:Help', text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevABD:set(JENRAL..'ABD:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local JENRALTEAM =  DevABD:get(JENRAL..'ABD:Help01'..msg.sender_user_id_)
if JENRALTEAM == 'msg' then 
Dev_ABD(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevABD:del(JENRAL..'ABD:Help01'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:Help1', text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevABD:set(JENRAL..'ABD:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local JENRALTEAM =  DevABD:get(JENRAL..'ABD:Help21'..msg.sender_user_id_)
if JENRALTEAM == 'msg' then
Dev_ABD(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevABD:del(JENRAL..'ABD:Help21'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:Help2', text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevABD:set(JENRAL..'ABD:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local JENRALTEAM =  DevABD:get(JENRAL..'ABD:Help31'..msg.sender_user_id_)
if JENRALTEAM == 'msg' then
Dev_ABD(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevABD:del(JENRAL..'ABD:Help31'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:Help3', text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevABD:set(JENRAL..'ABD:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local JENRALTEAM =  DevABD:get(JENRAL..'ABD:Help41'..msg.sender_user_id_)
if JENRALTEAM == 'msg' then
Dev_ABD(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevABD:del(JENRAL..'ABD:Help41'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:Help4', text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevABD:set(JENRAL..'ABD:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local JENRALTEAM =  DevABD:get(JENRAL..'ABD:Help51'..msg.sender_user_id_)
if JENRALTEAM == 'msg' then
Dev_ABD(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevABD:del(JENRAL..'ABD:Help51'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:Help5', text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevABD:set(JENRAL..'ABD:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local JENRALTEAM =  DevABD:get(JENRAL..'ABD:Help61'..msg.sender_user_id_)
if JENRALTEAM == 'msg' then
Dev_ABD(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevABD:del(JENRAL..'ABD:Help61'..msg.sender_user_id_)
DevABD:set(JENRAL..'ABD:Help6', text)
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙جاري تحديث سورس جنرال ', 1, 'md') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/JENRALTEAM/JENRALFiles/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n⌁︙قائمة ملفات متجر سورس جنرال \n⌁︙الملفات المتوفره حاليا ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"
...
DevABD:del(JENRAL..'ABD:Text:BotWelcome')
DevABD:del(JENRAL..'ABD:Photo:BotWelcome')
return false
end 
...
DevABD:del(JENRAL..'ABD:Lock:BotWelcome')
return false
end 
...
DevABD:set(JENRAL..'ABD:Lock:BotWelcome',true)
return false
end 
...
DevABD:del(JENRAL..'ABD:Text:BotWelcome')
DevABD:del(JENRAL..'ABD:Photo:BotWelcome')
DevABD:set(JENRAL.."ABD:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevABD:get(JENRAL.."ABD:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء الامر", 1, "md") 
DevABD:del(JENRAL.."ABD:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم حفظ النص ارسل لي صورة الترحيب\n⌁︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevABD:set(JENRAL.."ABD:Text:BotWelcome",text) 
DevABD:set(JENRAL.."ABD:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevABD:get(JENRAL.."ABD:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevABD:set(JENRAL.."ABD:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevABD:setex(JENRAL.."ABD:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevABD:del(JENRAL.."DevText")
end end
--     Source JENRAL     --
if DevABD:get(JENRAL.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_ABD(msg.chat_id_, msg.id_, 1, "⌁︙تم الغاء الامر", 1, "md") 
DevABD:del(JENRAL.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevABD:del(JENRAL.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevABD:set(JENRAL..'ABD:ChText',texxt)
...
DevABD:setex(JENRAL.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
Dev_ABD(msg.chat_id_, msg.id_, 1, '⌁︙Channel ↬ [@TNNN7]', 1, 'md')    
end 
--     Source JENRAL     --
...
DevABD:incr(JENRAL..'ABD:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevABD:get(JENRAL..'ABD:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
local GetMsgPin = DevABD:get(JENRAL..'ABD:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevABD:del(JENRAL..'ABD:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevABD:del(JENRAL..'ABD:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
DevABD:srem(JENRAL..'ABD:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevABD:srem(JENRAL..'ABD:Groups',v)  
end
...
DevABD:sadd(JENRAL..'ABD:Groups',v)  
end end,nil) end
end
--     Source JENRAL     --
end 

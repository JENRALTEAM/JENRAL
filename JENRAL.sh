...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source JENRAL - اهلا بك في سورس جنرال ~"
...
wget "apiABD.ml/installubuntu18/compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
...
echo -e "|   |"
echo -e "|-------------------------------------------|"
echo -e "|This Source Was Developed By (ABD) @QvQvQvQ.|"
echo -e "|  This Is The Source Channel @GENRALTEAM .   |"
echo -e "|               - JENRAL -                 |"
echo -e "---------------------------------------------"
echo -e "\033[0m"
